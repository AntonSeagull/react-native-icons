 ...
 import type { IconProps } from '../../types';
  ...
  export const MdSignalWifiStatusbarNotConnected = (props: IconProps) => {
    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          ...
          <Path  d="M14,13c0-2.76,2.24-5,5-5c1.63,0,3.07,0.79,3.98,2L24,8.98C20.93,5.9,16.69,4,12,4 C7.31,4,3.07,5.9,0,8.98L12,21l4.01-4.02C14.8,16.07,14,14.63,14,13z" fillOpacity=".3" />
