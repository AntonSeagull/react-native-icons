  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        ...
        <Path fillOpacity={0.3} d="M14 13c0-2.76 2.24-5 5-5 1.63 0 3.07.79 3.98 2L24 8.98A16.88 16.88 0 0 0 12 4C7.31 4 3.07 5.9 0 8.98L12 21l4.01-4.02C14.8 16.07 14 14.63 14 13" />
      </G>
    </Svg>
  );
};