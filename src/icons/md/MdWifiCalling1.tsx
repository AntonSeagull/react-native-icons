    ...
    return (
      ...
      >
        <G fill={color}>
          ...
          <Path d="M16.49,4.5c1.79,0,3.42,0.73,4.59,1.91l1.06-1.06C20.7,3.9,18.7,3,16.49,3c-2.21,0-4.21,0.9-5.66,2.34 l1.06,1.06C13.08,5.23,14.7,4.5,16.49,4.5z" />
          <Path d="M16.49,6c-1.38,0-2.63,0.56-3.54,1.46l1.06,1.06c0.63-0.63,1.51-1.03,2.47-1.03s1.84,0.39,2.47,1.03 l1.06-1.06C19.12,6.56,17.87,6,16.49,6z" />
          <Path d="M16.49,9c-0.55,0-1.05,0.22-1.41,0.59L16.49,11l1.41-1.41C17.54,9.22,17.04,9,16.49,9z" />
          <Path d="M15,17.83c1.29,0.54,2.63,0.89,4,1.07v-2.23l-2.35-0.47L15,17.83z" />
          <Path d="M7.33,5H5.1c0.18,1.37,0.53,2.7,1.07,4L7.8,7.35L7.33,5z" />
