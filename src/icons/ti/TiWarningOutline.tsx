...
export const TiWarningOutline = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        ...
        <Path d="M13.5 10c0-.83-.671-1.5-1.5-1.5a1.5 1.5 0 0 0-1.389 2.062C11.165 11.938 12 14 12 14l1.391-3.438c.068-.173.109-.363.109-.562" />
      </G>
    </Svg>
  );
};