 ...
 import type { IconProps } from '../../types';
  ...
  export const IoGiftSharp = (props: IconProps) => {
    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Path  d="M346,110a34,34,0,0,0-68,0v34h34A34,34,0,0,0,346,110Z" fill="none" />
          <Path  d="M234,110a34,34,0,1,0-34,34h34Z" fill="none" />
