  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        ...
        <Rect width={96} height={96} x={112} y={224} fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} rx={13} />
        <Path fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="M464 160H48" />
      </G>
    </Svg>
  );
};