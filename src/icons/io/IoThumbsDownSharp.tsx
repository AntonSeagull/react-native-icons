 ...
 import type { IconProps } from '../../types';
  ...
  export const IoThumbsDownSharp = (props: IconProps) => {
    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          ...
          <Path  d="M378.45,273.93A15.84,15.84,0,0,1,386,272h0a15.93,15.93,0,0,0-7.51,1.91Z" fill="none" />
          <Path  d="M337.86,343.22l-.13.22a2.53,2.53,0,0,1,.13-.22c20.5-35.51,30.36-55,33.82-62h0C368.21,288.28,358.34,307.73,337.86,343.22Z" fill="none" />
