 ...
 import type { IconProps } from '../../types';
  ...
  export const IoTrendingDown = (props: IconProps) => {
    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Polyline  points="352 368 464 368 464 256" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
