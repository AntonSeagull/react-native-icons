    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Polyline  points="135.87 256 159.46 232.4 184.13 256" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
          <Polyline  points="376.13 256 352.54 279.6 327.87 256" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
