    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Polyline  points="124 158 124 136 100 136 100 158" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
          <Polyline  points="196 272 176 252 156 272" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
          <Polyline  points="356 272 336 292 316 272" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
