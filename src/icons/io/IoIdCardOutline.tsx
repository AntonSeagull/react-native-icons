...
export const IoIdCardOutline = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Rect width={320} height={448} x={96} y={32} fill="none" stroke="#000" strokeLinejoin="round" strokeWidth={32} rx={48} />
        <Path fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="M208 80h96" />
