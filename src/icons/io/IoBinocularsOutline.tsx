    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Circle  cx="392" cy="344" r="88" strokeWidth="32" strokeLinecap="round" strokeLinejoin="round" />
          <Circle  cx="120" cy="344" r="88" strokeWidth="32" strokeLinecap="round" strokeLinejoin="round" />
