    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          ...
          <Path  d="M256,384c22.28,0,39.36-10.63,39.66-32H216C216,373.75,233.53,384,256,384Z" fill="none" />
          <Path  d="M295.67,352H296l-.32-.57C295.68,351.62,295.67,351.81,295.67,352Z" fill="none" />
