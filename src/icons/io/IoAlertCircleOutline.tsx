    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          ...
          <Path  d="M250.26,166.05,256,288l5.73-121.95a5.74,5.74,0,0,0-5.79-6h0A5.74,5.74,0,0,0,250.26,166.05Z" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
