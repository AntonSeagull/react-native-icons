 ...
 import type { IconProps } from '../../types';
  ...
  export const IoLocate = (props: IconProps) => {
    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          ...
          <Path  d="M256,112A144,144,0,1,0,400,256,144,144,0,0,0,256,112Z" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="48px" />
        </G>
      </Svg>
    );
  }
