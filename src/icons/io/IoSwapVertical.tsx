    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Polyline  points="464 208 352 96 240 208" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
          <Polyline  points="48 304 160 416 272 304" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
