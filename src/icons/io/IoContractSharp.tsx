    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Polyline  points="304 416 304 304 416 304" fill="none" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="32px" />
          <Polyline  points="208 96 208 208 96 208" fill="none" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="32px" />
          <Polyline  points="416 208 304 208 304 96" fill="none" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="32px" />
          <Polyline  points="96 304 208 304 208 416" fill="none" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="32px" />
