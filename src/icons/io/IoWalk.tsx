 ...
 import type { IconProps } from '../../types';
  ...
  export const IoWalk = (props: IconProps) => {
    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Circle  cx="257" cy="69.56" r="37.04" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16px" />
          <Path  d="M312.55,479.9l-56.42-114-44.62-57A72.37,72.37,0,0,1,201.45,272V143.64H217a40,40,0,0,1,40,40V365.85" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
          <Path  d="M127.38,291.78V217.71s37-74.07,74.07-74.07" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32px" />
