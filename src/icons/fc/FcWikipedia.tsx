 ...
 import type { IconProps } from '../../types';
  ...
  export const FcWikipedia = (props: IconProps) => {
   ...
   const {
    ...
    return (
      ...
      >
        <G fill={color}>
          <Path d="M6,10c0-2.209,1.791-4,4-4h28c2.209,0,4,1.791,4,4v28c0,2.209-1.791,4-4,4H10c-2.209,0-4-1.791-4-4V10z" fill="#CFD8DC" />
          <Path d="M39,17.271c0,0.191-0.148,0.349-0.334,0.349h-1.799l-8.164,18.179c-0.052,0.12-0.17,0.2-0.297,0.202h-0.004
	...
	c0.186,0,0.334,0.156,0.334,0.348V17.271z" fill="#37474F" />
        </G>
      </Svg>
    );
  }
