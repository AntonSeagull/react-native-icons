...
export const FcDisapprove = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        ...
        <Path d="m16.077 20.91 2.828-2.828 13.08 13.08-2.829 2.827z" />
        <Path d="m29.09 18.077 2.828 2.828-13.08 13.08-2.827-2.829z" />
      </G>
    </Svg>
  );
};