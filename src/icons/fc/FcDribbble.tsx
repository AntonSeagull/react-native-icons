 ...
 import type { IconProps } from '../../types';
  ...
  export const FcDribbble = (props: IconProps) => {
   ...
   const {
    ...
    return (
      ...
      >
        <G fill={color}>
          <Path d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z" fill="#FF4081" />
          <Path d="M33.061,26.273c-0.703-0.221-1.464,0.175-1.686,0.895c-0.824,2.658-2.316,5.419-2.993,5.57
	...
	C26.289,22.616,25.75,25.446,24.901,27.926z" fill="#FFFFFF" />
        </G>
      </Svg>
    );
  }
