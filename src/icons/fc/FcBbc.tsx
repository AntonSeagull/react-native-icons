  ...
  export const FcBbc = (props: IconProps) => {
   ...
   const {
    ...
    return (
      ...
      >
        <G fill={color}>
          <Path d="M0,17v14h14V17H0z M34,17v14h14V17H34z M17,17v14h14V17H17z" fill="#37474F" />
          <Path d="M8.2,23.7c0,0,1.3-0.5,1.3-2c0,0,0.2-2.4-3-2.7H3v10h4c0,0,3.4,0,3.4-2.8C10.4,26.2,10.5,24.3,8.2,23.7z
	...
	L45.3,28.1L45.3,28.1z" fill="#FFFFFF" />
        </G>
      </Svg>
    );
  }
