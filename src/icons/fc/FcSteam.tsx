 ...
 import type { IconProps } from '../../types';
  ...
  export const FcSteam = (props: IconProps) => {
   ...
   const {
    ...
    return (
      ...
      >
        <G fill={color}>
          <Path d="M42,38c0,2.209-1.791,4-4,4H10c-2.209,0-4-1.791-4-4V10c0-2.209,1.791-4,4-4h28c2.209,0,4,1.791,4,4V38z" fill="#FFFFFF" />
          <Path d="M18.459,33.645c-0.288,0-0.56-0.057-0.822-0.141l-0.005,0.02l-3.67-1.062
		...
		C21.184,32.424,19.964,33.645,18.459,33.645z" fill="#455A64" />
          <Path d="M30.923,24.299c3.222,0,5.837-2.615,5.837-5.838c0-3.222-2.615-5.837-5.837-5.837
		...
		c0,2.241-1.815,4.053-4.056,4.053c-2.236,0-4.049-1.812-4.049-4.053C26.871,16.223,28.684,14.409,30.92,14.409z" fill="#455A64" />
          <Path d="M38,6h-2.75h-22.5H10c-2.209,0-4,1.791-4,4v2.75v4.236v7.509l7.027,2.033
		...
		C42,7.791,40.209,6,38,6z" fill="#455A64" />
        </G>
      </Svg>
    );
  }
