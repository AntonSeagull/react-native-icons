    ...
    return (
      ...
      >
        <G fill={color}>
          ...
          <Path d="M2 8C0.895431 8 0 8.89543 0 10V14C0 15.1046 0.89543 16 2 16H22C23.1046 16 24 15.1046 24 14V10C24 8.89543 23.1046 8 22 8H2ZM22 10H2L2 14H22V10Z" fill="currentColor" />
        </G>
      </Svg>
    );
  }
