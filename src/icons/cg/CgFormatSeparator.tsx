    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Path  d="M21 16C21 16.5523 20.5523 17 20 17L4 17C3.44772 17 3 16.5523 3 16C3 15.4477 3.44772 15 4 15L20 15C20.5523 15 21 15.4477 21 16Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd" />
