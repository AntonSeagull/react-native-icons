  ...
  export const CgShoppingCart = (props: IconProps) => {
   ...
   const {
    ...
    return (
      ...
      >
        <G fill={color}>
          <Path d="M5.79166 2H1V4H4.2184L6.9872 16.6776H7V17H20V16.7519L22.1932 7.09095L22.5308 6H6.6552L6.08485 3.38852L5.79166 2ZM19.9869 8H7.092L8.62081 15H18.3978L19.9869 8Z" fill="currentColor" />
