...
export const VscCompassActive = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        ...
        <Path fillRule="evenodd" d="M11.333 10.506a3 3 0 1 1 3.333 4.987 3 3 0 0 1-3.333-4.987m1.698 3.817 1.79-2.387-.8-.6-1.48 1.974-.876-.7-.624.78 1.278 1.023z" clipRule="evenodd" />
      </G>
    </Svg>
  );
};