...
export const VscDebugAll = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        ...
        <Path fillRule="evenodd" d="M3.78 2 3 2.41V7h1V3.35l7.6 5.07L9 10.15v1.2l3.78-2.52V8zM9 13.35v-1.202l5.6-3.728L7 3.35V2.147L15.78 8v.83z" clipRule="evenodd" />
      </G>
    </Svg>
  );
};