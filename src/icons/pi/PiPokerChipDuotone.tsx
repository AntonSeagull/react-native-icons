...
export const PiPokerChipDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M128 32a96 96 0 1 0 96 96 96 96 0 0 0-96-96m0 152a56 56 0 1 1 56-56 56 56 0 0 1-56 56" opacity={0.2} />
