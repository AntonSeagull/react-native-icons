...
export const PiPantsDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M202.05 104H200a40 40 0 0 1-40-40H96a40 40 0 0 1-40 40h-2l8.06-65A8 8 0 0 1 70 32h116a8 8 0 0 1 7.94 7Z" opacity={0.2} />
