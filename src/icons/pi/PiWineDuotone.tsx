...
export const PiWineDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M182.48 162.5a79.77 79.77 0 0 1-109 0 55.86 55.86 0 0 1-15.18-56.57l1.57-5.31C72.49 95.21 95.2 91.4 128 108c35.86 18.16 59.67 11.89 71.42 5.84a55.72 55.72 0 0 1-16.94 48.66" opacity={0.2} />
