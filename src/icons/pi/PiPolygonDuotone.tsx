...
export const PiPolygonDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M137 65a24 24 0 1 1 0-34 24 24 0 0 1 0 34M23 103a24 24 0 1 0 34 0 24 24 0 0 0-34 0m120 88a24 24 0 1 0 34 0 24 24 0 0 0-34 0m82-136a24 24 0 1 0 0 34 24 24 0 0 0 0-34" opacity={0.2} />
