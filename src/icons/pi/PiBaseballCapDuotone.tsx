    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Path  d="M224,152v32a16,16,0,0,1-25.48,12.88C182.53,185.26,159,176,128,176s-54.53,9.26-70.52,20.88A16,16,0,0,1,32,184V152a160,160,0,0,1,192,0Z" opacity="0.2" />
