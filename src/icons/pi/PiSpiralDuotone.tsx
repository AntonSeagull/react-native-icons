...
export const PiSpiralDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M240 144h-32a80 80 0 0 1-80 80 88 88 0 0 1-88-88 96 96 0 0 1 96-96 104 104 0 0 1 104 104" opacity={0.2} />
