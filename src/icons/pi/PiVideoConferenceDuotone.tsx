...
export const PiVideoConferenceDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M40 48a8 8 0 0 0-8 8v144a8 8 0 0 0 8 8h120V48Zm56 96a24 24 0 1 1 24-24 24 24 0 0 1-24 24" opacity={0.2} />
