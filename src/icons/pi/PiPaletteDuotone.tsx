...
export const PiPaletteDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M224 127.17a96.5 96.5 0 0 1-2.39 22.18 24 24 0 0 1-23.4 18.65H152a24 24 0 0 0-24 24 24 24 0 0 1-32 22.61c-37.27-13.17-64-44.8-64-86.61a96 96 0 0 1 95-96c52.84-.53 96.55 42.35 97 95.17" opacity={0.2} />
