...
export const PiMoonStarsDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M210.69 158.18A88 88 0 1 1 97.82 45.31 96.08 96.08 0 0 0 192 160a96.8 96.8 0 0 0 18.69-1.82" opacity={0.2} />
