...
export const PiChatsTeardropDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M232 152v64a8 8 0 0 1-8 8h-64a72 72 0 0 1-67.9-48H96a72 72 0 0 0 72-72 71.8 71.8 0 0 0-4.07-23.88A72 72 0 0 1 232 152" opacity={0.2} />
