...
export const PiGitDiffDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M80 64a24 24 0 1 1-24-24 24 24 0 0 1 24 24m120 104a24 24 0 1 0 24 24 24 24 0 0 0-24-24" opacity={0.2} />
