...
export const PiCirclesFourDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M112 80a32 32 0 1 1-32-32 32 32 0 0 1 32 32m64 32a32 32 0 1 0-32-32 32 32 0 0 0 32 32m-96 32a32 32 0 1 0 32 32 32 32 0 0 0-32-32m96 0a32 32 0 1 0 32 32 32 32 0 0 0-32-32" opacity={0.2} />
