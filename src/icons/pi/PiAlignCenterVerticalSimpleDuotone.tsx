 ...
 import type { IconProps } from '../../types';
  ...
  export const PiAlignCenterVerticalSimpleDuotone = (props: IconProps) => {
    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Path  d="M168,48V208a8,8,0,0,1-8,8H96a8,8,0,0,1-8-8V48a8,8,0,0,1,8-8h64A8,8,0,0,1,168,48Z" opacity="0.2" />
