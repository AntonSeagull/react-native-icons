...
export const PiHandDepositDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M184 96v106.31L173.32 186a20 20 0 0 0-36.9 14H56V96a8 8 0 0 1 8-8h112a8 8 0 0 1 8 8" opacity={0.2} />
