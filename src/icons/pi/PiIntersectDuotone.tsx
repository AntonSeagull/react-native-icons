...
export const PiIntersectDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M168 96a72 72 0 0 1-72 72 73 73 0 0 1-7.6-.4 73 73 0 0 1-.4-7.6 72 72 0 0 1 72-72 73 73 0 0 1 7.6.4 73 73 0 0 1 .4 7.6" opacity={0.2} />
