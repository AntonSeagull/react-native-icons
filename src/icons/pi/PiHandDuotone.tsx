...
export const PiHandDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M208 76v76a80 80 0 0 1-80 80c-44.18 0-60.75-21.28-93.32-90a20 20 0 0 1 34.64-20L88 152V60a20 20 0 0 1 40 0V44a20 20 0 0 1 40 0v32a20 20 0 0 1 40 0" opacity={0.2} />
