...
export const PiPaintBrushHouseholdDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="m225 65-69 59 16.69 16.69a16 16 0 0 1 0 22.62L152 184l-80-80 20.69-20.69a16 16 0 0 1 22.62 0L132 100l59-69a24 24 0 0 1 34 34" opacity={0.2} />
