...
export const PiHammerDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M245.66 129 217 157.66a8 8 0 0 1-11.3 0L168.1 120l-28 28-32-32 28-28L80 31.78a87.81 87.81 0 0 1 98.31 18l67.35 67.89a8 8 0 0 1 0 11.33" opacity={0.2} />
