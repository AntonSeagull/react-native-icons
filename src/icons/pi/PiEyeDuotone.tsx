...
export const PiEyeDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M128 56c-80 0-112 72-112 72s32 72 112 72 112-72 112-72-32-72-112-72m0 112a40 40 0 1 1 40-40 40 40 0 0 1-40 40" opacity={0.2} />
