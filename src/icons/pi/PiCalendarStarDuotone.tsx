...
export const PiCalendarStarDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="m149.6 143.41 8.07 32.59L128 158.54 98.33 176l8.07-32.59-26.4-21.8 34.65-2.67L128 88l13.35 30.94 34.65 2.67Z" opacity={0.2} />
