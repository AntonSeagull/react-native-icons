...
export const PiUsersThreeDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M168 144a40 40 0 1 1-40-40 40 40 0 0 1 40 40M64 56a32 32 0 1 0 32 32 32 32 0 0 0-32-32m128 0a32 32 0 1 0 32 32 32 32 0 0 0-32-32" opacity={0.2} />
