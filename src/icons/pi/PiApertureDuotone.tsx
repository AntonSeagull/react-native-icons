...
export const PiApertureDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M195.88 60.12a96 96 0 1 0 0 135.76 96 96 0 0 0 0-135.76m-55.34 103-36.68-6.69-12.54-35.13 24.14-28.41 36.68 6.69 12.54 35.12Z" opacity={0.2} />
