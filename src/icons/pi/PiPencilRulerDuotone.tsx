...
export const PiPencilRulerDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M40 184h64v24a8 8 0 0 1-8 8H48a8 8 0 0 1-8-8ZM208 40h-48a8 8 0 0 0-8 8v160a8 8 0 0 0 8 8h48a8 8 0 0 0 8-8V48a8 8 0 0 0-8-8" opacity={0.2} />
