 ...
 import type { IconProps } from '../../types';
  ...
  export const PiLighthouseDuotone = (props: IconProps) => {
    ...
    return (
      ...
      >
        <G fill={color} stroke={color}>
          <Path  d="M181.61,112H74.39L80,56h96ZM192,215.24,187.23,168H68.77L64,215.24A8,8,0,0,0,72,224H184A8,8,0,0,0,192,215.24Z" opacity="0.2" />
