...
export const PiFalloutShelterDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M128 32a96 96 0 1 0 96 96 96 96 0 0 0-96-96m32 144-32-48-32 48-32-48h64L96 80h64l-32 48h64Z" opacity={0.2} />
