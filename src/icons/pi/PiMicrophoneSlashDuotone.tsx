...
export const PiMicrophoneSlashDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M168 64v64a40 40 0 0 1-40 40 40 40 0 0 1-40-40V64a40 40 0 0 1 40-40 40 40 0 0 1 40 40" opacity={0.2} />
