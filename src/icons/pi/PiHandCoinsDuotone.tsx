...
export const PiHandCoinsDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M16 152h32v56H16a8 8 0 0 1-8-8v-40a8 8 0 0 1 8-8m188-96a28 28 0 0 0-12 2.71 28 28 0 1 0-16 26.58A28 28 0 1 0 204 56" opacity={0.2} />
