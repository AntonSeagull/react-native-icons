...
export const PiBaseballDuotone = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        <Path d="M60.66 59.58A95.74 95.74 0 0 1 89.33 128a95.74 95.74 0 0 1-28.67 68.42 96 96 0 0 1 0-136.84m134.68 0a96 96 0 0 0 0 136.84 96 96 0 0 0 0-136.84" opacity={0.2} />
