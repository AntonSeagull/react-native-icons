 ...
 import type { IconProps } from '../../types';
  ...
  export const AiTwotoneMail = (props: IconProps) => {
   ...
   const {
    ...
    return (
      ...
      >
        <G fill={color}>
          <Path d="M477.5 536.3L135.9 270.7l-27.5-21.4 27.6 21.5V792h752V270.8L546.2 536.3a55.99 55.99 0 0 1-68.7 0z" fill="#D9D9D9" />
          <Path d="M876.3 198.8l39.3 50.5-27.6 21.5 27.7-21.5-39.3-50.5z" fill="#D9D9D9" />
