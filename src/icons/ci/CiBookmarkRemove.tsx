...
export const CiBookmarkRemove = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        ...
        <Path d="M10.23 10.84a.5.5 0 0 0 .71.71L12 10.491l1.06 1.059a.523.523 0 0 0 .71 0 .513.513 0 0 0 0-.71l-1.061-1.061L13.77 8.72a.5.5 0 0 0-.71-.71c-.35.35-.7.71-1.06 1.06l-1.06-1.06a.5.5 0 0 0-.71 0 .524.524 0 0 0 0 .71c.35.35.71.7 1.06 1.06Z" />
      </G>
    </Svg>
  );
};