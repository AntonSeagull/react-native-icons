...
export const CiBookmarkCheck = (props: IconProps) => {
  const {
    size = 24,
    fill = 'black',
    stroke = 'black',
  ...
  return (
    ...
    >
      <G fill={fill} stroke={stroke}>
        ...
        <Path d="M14.85 9.08c-.11.12-.23.23-.35.35-.83.83-1.65 1.65-2.47 2.48a.513.513 0 0 1-.71 0c-.47-.48-.94-.95-1.42-1.42a.5.5 0 0 1 .71-.71c.35.36.7.71 1.06 1.06.83-.82 1.65-1.65 2.48-2.47.45-.46 1.16.25.7.71" />
      </G>
    </Svg>
  );
};